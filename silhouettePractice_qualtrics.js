...
Qualtrics.SurveyEngine.addOnload(function () {
    ...
    var requiredResources = [
        ...
        task_github + "silhouettePractice_main.js"
    ];
    ...
    function initExp() {
        ...
        jsPsych.init({
            ...
            on_finish: function (data) {
                ...
                Qualtrics.SurveyEngine.setEmbeddedData("responseTimes", responseTimes);
                Qualtrics.SurveyEngine.setEmbeddedData("userChoice", userChoice);
