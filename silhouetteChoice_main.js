...
var intro = {
    ...
    <br/>Please click "Next" to proceed`,
...
for (var values of foursilhouettes) {
  ...
  if (condition == "baseline") {
    var genderChoice = {
    type: 'html-keyboard-response',
    stimulus: 'Now you will see a few groups of human lives that are the same age but differ in gender.<br>Please left click on the one you wish to save. <br>Please click "Next" to continue.'，
    show_clickable_nav: true
    };
  } else if (condition == "negative") {
    var genderChoice = {
      type: 'html-keyboard-response',
      stimulus: 'Now you will see a few groups of human lives that are the same age but differ in gender.<br>Please left click on the one you wish to give up. <br>Please click "Next" to continue.'，
      show_clickable_nav: true 
    };
  } else if (condition == "general") {
    var genderChoice = {
      type: 'html-keyboard-response',
      stimulus: 'Now you will see a few groups of human lives that are the same age but differ in gender.<br>Please left click on the life the policy should save. <br>Please click "Next" to continue.',
      show_clickable_nav: true
    };
  };
...
var debrief_block = {
            ...
            return `<p>Please press any key to complete the experiment. Thank you!</p>`;
            }
            };
